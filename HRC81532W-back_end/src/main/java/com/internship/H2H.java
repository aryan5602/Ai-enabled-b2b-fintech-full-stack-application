...
public class H2H {
	...
	public H2H(int sl_no, String business_code, String cust_number, String clear_date, int buisness_year, String doc_id,
			...
			double total_open_amount, String baseline_create_date, String cust_payment_terms, String invoice_id,
			int isOpen,String aging_bucket,Boolean is_deleted) {
		super();
		this.sl_no = sl_no;
...
//		this.is_deleted = is_deleted;
	...
	public String getCust_payemnt_terms() {
