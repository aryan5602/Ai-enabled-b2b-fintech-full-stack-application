public class POJO {
	...
	public void setCust_payement_terms(String cust_payement_terms) {
		this.cust_payment_terms = cust_payement_terms;
	}
	...
	public POJO(int sl_no, String business_code, int cust_number, String clear_date, int buisness_year, String doc_id,
			...
			boolean isOpen, String aging_bucket, boolean is_deleted) {
		super();
		this.sl_no = sl_no;
		this.business_code = business_code;
		this.cust_number = cust_number;
